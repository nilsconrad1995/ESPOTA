...
function CheckVersion(){
  ...
  .then(_ => fetch('https://raw.githubusercontent.com/nilsconrad1995/ESPOTA/master/version.json'))
    ...
    Popup.create({
      ...
      buttons: {
          left: [{
              text: 'Yes',
              action: function () {
                fetch('https://raw.githubusercontent.com/nilsconrad1995/ESPOTA/master/' + latestCompatibleSoftware + '.bin')
                .then(function (response) {
